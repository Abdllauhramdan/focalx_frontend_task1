...
import FilterButtons from "../Components/Property/filterButtons";
...
function Properties() {
  return (
    <div className="app">
      <Comunication/>
      <Navbar active={2} />
      <PropertyIntroCard title="HOME / PROPERTIES" subTitle={"PROPERTIES"} />
      <FilterButtons />
      <div className="cssforcards" style={{marginTop:"0%"}}>
        <HCard
          photo={pic1}
          type="Luxury Villa"
          price="$2.264.000"
